...
public class CircularSeekBar extends View {
    ...
    private static final int DEFAULT_CIRCLE_COLOR = Color.argb(224, 224, 224, 224);
    private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(236, 236, 81, 107);
